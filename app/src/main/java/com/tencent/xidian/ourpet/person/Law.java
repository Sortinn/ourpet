...
//一般数据
        ...
        bmpW = decodeResource(res, R.raw.law_stand).getWidth();
        bmpH = decodeResource(res, R.raw.law_stand).getHeight();
...
//初始化的xy
    ...
    private void onActionChange(int actionFlag){
        ...
        switch (actionFlag){
            case FLAG_CRAWL:
                bmpLaw[0] = decodeResource(res, R.raw.law_crawl_1);
                bmpLaw[1] = decodeResource(res, R.raw.law_crawl_2);
                bmpLaw[2] = decodeResource(res, R.raw.law_crawl_3);
                break;
            case FLAG_DOWN:
                if(x < 0) x = 0;
                if(x > screenW-bmpW*personSize) x = screenW-bmpW*personSize;
                bmpLaw[0] = decodeResource(res, R.raw.law_down_1);
                bmpLaw[1] = decodeResource(res, R.raw.law_down_2);
                bmpLaw[2] = decodeResource(res, R.raw.law_down_3);
                break;
            case FLAG_SLEEPY:
                bmpLaw[0] = decodeResource(res, R.raw.law_sleepy_1);
                bmpLaw[1] = decodeResource(res, R.raw.law_sleepy_2);
                bmpLaw[2] = decodeResource(res, R.raw.law_sleepy_3);
                break;
            case FLAG_SIT:
                frameFlag = (int)(Math.random()*2);
                bmpLaw[0] = decodeResource(res, R.raw.law_sit_1);
                bmpLaw[1] = decodeResource(res, R.raw.law_sit_2);
                break;
            case FLAG_STAND:
                bmpLaw[0] = decodeResource(res, R.raw.law_stand);
                break;
            case FLAG_UP:
                bmpLaw[0] = decodeResource(res, R.raw.law_up_1);
                bmpLaw[1] = decodeResource(res, R.raw.law_up_2);
                bmpLaw[2] = decodeResource(res, R.raw.law_up_3);
                break;
            case FLAG_WALK2:
                upOrDown = Math.random()< 0.5 ? 1:-1;
            case FLAG_WALK:
                bmpLaw[0] = decodeResource(res, R.raw.law_stand);
                bmpLaw[1] = decodeResource(res, R.raw.law_walk_1);
                bmpLaw[2] = decodeResource(res, R.raw.law_walk_2);
                break;
            case FLAG_DANCE:
                bmpLaw[0] = decodeResource(res, R.raw.law_dance_1);
                bmpLaw[1] = decodeResource(res, R.raw.law_dance_2);
        }
    }
}