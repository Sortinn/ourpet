...
//一般数据
        ...
        bmpW = decodeResource(res, R.raw.zoro_eat_1).getWidth();
        bmpH = decodeResource(res, R.raw.zoro_eat_1).getHeight();
    ...
    private void onActionChange(int actionFlag){
        ...
        switch (actionFlag){
            case FLAG_DOWN:
                ...
                bmpZoro[0] = decodeResource(res, R.raw.zoro_down_2);
                bmpZoro[1] = decodeResource(res, R.raw.zoro_down_3);
                bmpZoro[2] = decodeResource(res, R.raw.zoro_stand);
                break;
            case FLAG_EAT:
                bmpZoro[0] = decodeResource(res, R.raw.zoro_eat_1);
                bmpZoro[1] = decodeResource(res, R.raw.zoro_eat_2);
                bmpZoro[2] = decodeResource(res, R.raw.zoro_eat_3);
                break;
            case FLAG_SIT:
                bmpZoro[0] = decodeResource(res, R.raw.zoro_sit);
                break;
            case FLAG_STAND:
                bmpZoro[0] = decodeResource(res, R.raw.zoro_stand);
                break;
            case FLAG_UP:
                bmpZoro[0] = decodeResource(res, R.raw.zoro_stand);
                bmpZoro[1] = decodeResource(res, R.raw.zoro_up_1);
                bmpZoro[2] = decodeResource(res, R.raw.zoro_up_2);
                break;
            case FLAG_WALK2:
                upOrDown = Math.random()< 0.5 ? 1:-1;
            case FLAG_WALK:
                bmpZoro[0] = decodeResource(res, R.raw.zoro_walk_1);
                bmpZoro[1] = decodeResource(res, R.raw.zoro_walk_2);
                bmpZoro[2] = decodeResource(res, R.raw.zoro_walk_3);
                break;
            case FLAG_SLEEP:
                bmpZoro[0] = decodeResource(res, R.raw.zoro_sleep_1);
                bmpZoro[1] = decodeResource(res, R.raw.zoro_sleep_2);
                bmpZoro[2] = decodeResource(res, R.raw.zoro_sleep_3);
                break;
        }
    }
}
