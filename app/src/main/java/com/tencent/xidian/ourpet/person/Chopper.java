...
//一般数据
        ...
        bmpW = decodeResource(res, R.raw.chopper_ball).getWidth();
        bmpH = decodeResource(res, R.raw.chopper_ball).getHeight();
    ...
    private void onActionChange(int actionFlag){
        ...
        switch (actionFlag){
            case FLAG_DOWN:
                ...
                bmpImage[0] = decodeResource(res, R.raw.chopper_down_0_1);
                bmpImage[1] = decodeResource(res, R.raw.chopper_down_1_1);
                bmpImage[2] = null;
                if(barFlag){
                    bmpTools[0] = decodeResource(res, R.raw.chopper_down_0_2);
                    bmpTools[1] = decodeResource(res, R.raw.chopper_down_1_2);
                    bmpTools[2] = null;
                    bmpTools[3] = null;
                    bmpTools[4] = null;
                }
            ...
            case FLAG_SIT:
                ...
                bmpImage[0] = decodeResource(res, R.raw.chopper_sit);
                bmpImage[1] = null;
                bmpImage[2] = null;
                if(barFlag){
                    bmpTools[0] = decodeResource(res, R.raw.chopper_sit_0_1);
                    bmpTools[1] = null;
                    bmpTools[2] = null;
                    bmpTools[3] = null;
                    bmpTools[4] = null;
                ...
                break;
            case FLAG_STAND:
                bmpImage[0] = decodeResource(res, R.raw.chopper_stand_0_1);
                bmpImage[1] = null;
                bmpImage[2] = null;
                if(barFlag){
                    bmpTools[0] = decodeResource(res, R.raw.chopper_stand_0_2);
                    bmpTools[1] = null;
                    bmpTools[2] = null;
                    bmpTools[3] = null;
                    bmpTools[4] = null;
            ...
            case FLAG_UP:
                bmpImage[0] = decodeResource(res, R.raw.chopper_stand_0_1);
                bmpImage[1] = decodeResource(res, R.raw.chopper_up_0_1);
                bmpImage[2] = decodeResource(res, R.raw.chopper_up_1_1);
                if(barFlag){
                    bmpTools[0] = decodeResource(res, R.raw.chopper_stand_0_2);
                    bmpTools[1] = decodeResource(res, R.raw.chopper_up_0_2);
                    bmpTools[2] = decodeResource(res, R.raw.chopper_up_1_2);
                    bmpTools[3] = null;
                    bmpTools[4] = null;
                    bmpTools[5] = null;
                }
            ...
            case FLAG_WALK:
                bmpImage[0] = decodeResource(res, R.raw.chopper_walk_0_1);
                bmpImage[1] = decodeResource(res, R.raw.chopper_walk_1_1);
                bmpImage[2] = decodeResource(res, R.raw.chopper_walk_2_1);
                if(barFlag){
                    bmpTools[0] = decodeResource(res, R.raw.chopper_walk_0_2);
                    bmpTools[1] = decodeResource(res, R.raw.chopper_walk_1_2);
                    bmpTools[2] = decodeResource(res, R.raw.chopper_walk_2_2);
                    bmpTools[3] = null;
                    bmpTools[4] = null;
                    bmpTools[5] = null;
                }
                break;
            case FLAG_EAT:
                bmpImage[0] = decodeResource(res, R.raw.chopper_eat_1_1);
                bmpImage[1] = decodeResource(res, R.raw.chopper_eat_2_1);
                bmpImage[2] = decodeResource(res, R.raw.chopper_eat_3_1);
                if(barFlag){
                    bmpTools[0] = decodeResource(res, R.raw.chopper_eat_0_2);
                    bmpTools[1] = null;
                    bmpTools[2] = null;
                    bmpTools[3] = null;
                    bmpTools[4] = null;
            ...
            case FLAG_BALL:
                ...
                bmpImage[0] = decodeResource(res, R.raw.chopper_ball);
                bmpImage[1] = null;
                bmpImage[2] = null;
                break;
            case FLAG_SLEEP:
                bmpImage[0] = decodeResource(res, R.raw.chopper_sleep_0_1);
                bmpImage[1] = decodeResource(res, R.raw.chopper_sleep_1_1);
                bmpImage[2] = decodeResource(res, R.raw.chopper_sleep_2_1);
                if(barFlag){
                    bmpTools[0] = decodeResource(res, R.raw.chopper_sleep_0_2);
                    bmpTools[5] = null;
                }
                bmpTools[1] = decodeResource(res, R.raw.chopper_sleep_3_0);
                bmpTools[2] = decodeResource(res, R.raw.chopper_sleep_3_1);
                bmpTools[3] = decodeResource(res, R.raw.chopper_sleep_3_2);
                bmpTools[4] = decodeResource(res, R.raw.chopper_sleep_3_3);
                break;
            case FLAG_HAPPY:
                bmpImage[0] = decodeResource(res, R.raw.chopper_happy_0_1);
                bmpImage[1] = decodeResource(res, R.raw.chopper_happy_1_1);
                bmpImage[2] = decodeResource(res, R.raw.chopper_happy_2_1);
                if(barFlag){
                    bmpTools[0] = decodeResource(res, R.raw.chopper_happy_0_2);
                    bmpTools[1] = decodeResource(res, R.raw.chopper_happy_1_2);
                    bmpTools[2] = decodeResource(res, R.raw.chopper_happy_2_2);
                }
                bmpTools[3] = decodeResource(res, R.raw.chopper_happy_0_3);
                bmpTools[4] = decodeResource(res, R.raw.chopper_happy_1_3);
                bmpTools[5] = decodeResource(res, R.raw.chopper_happy_2_3);
                break;
            case FLAG_SHOCK:
                bmpImage[0] = decodeResource(res, R.raw.chopper_shock_0_1);
                bmpImage[1] = decodeResource(res, R.raw.chopper_shock_1_1);
                bmpImage[2] = decodeResource(res, R.raw.chopper_shock_2_1);
                if(barFlag){
                    bmpTools[0] = decodeResource(res, R.raw.chopper_shock_0_2);
                    bmpTools[1] = decodeResource(res, R.raw.chopper_shock_1_2);
                    bmpTools[2] = decodeResource(res, R.raw.chopper_shock_2_2);
                    bmpTools[3] = null;
                    bmpTools[4] = null;
                    bmpTools[5] = null;
                }
                break;
            case FLAG_STAR:
                bmpImage[0] = decodeResource(res, R.raw.chopper_star_0_1);
                bmpImage[1] = decodeResource(res, R.raw.chopper_star_1_1);
                bmpImage[2] = null;
                if(barFlag){
                    bmpTools[0] = decodeResource(res, R.raw.chopper_star_0_2);
                    bmpTools[1] = null;
                    bmpTools[2] = null;
                    bmpTools[3] = null;
                    bmpTools[4] = null;
